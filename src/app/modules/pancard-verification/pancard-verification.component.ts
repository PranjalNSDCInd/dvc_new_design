...
@Component({
  selector: 'app-pancard-verification',
  templateUrl: './pancard-verification.component.html',
  styleUrls: ['./pancard-verification.component.css']
})
export class PancardVerificationComponent {
